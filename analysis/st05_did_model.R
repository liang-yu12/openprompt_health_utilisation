...
check_zero$dispersion <- summary(model_poisson)$deviance / df.residual(model_poisson)

check_zero %>% write.csv(here("output", "model_comparison.csv"), row.names = F)
# 
