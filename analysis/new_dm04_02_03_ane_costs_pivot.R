source("analysis/new_dm04_02_combine_costs_new_data.R")
...
matched_ane_cost_ts <- bind_rows(exp_cost_long, com_cost_long)
# fix the exposure levels
matched_ane_cost_ts$exposure <- relevel(matched_ane_cost_ts$exposure, ref = "Comparator")
