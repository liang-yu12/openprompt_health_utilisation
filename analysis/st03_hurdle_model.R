...
month_adj_hurdle_fn <- function(month, n, data) {
      # Fit a hurdle model to the data.
      model <- hurdle(
            month ~ exposure + age_cat + sex | exposure + age_cat + sex,
            data = data,
            zero.dist = "binomial",
            dist = "poisson"
      )
...
all_par_adj_results <- bind_rows(
      month_adj_hurdle_fn(matched_data$all_month1, 1, data = matched_data),
      month_adj_hurdle_fn(matched_data$all_month2, 2, data = matched_data),
      month_adj_hurdle_fn(matched_data$all_month3, 3, data = matched_data),
      month_adj_hurdle_fn(matched_data$all_month4, 4, data = matched_data),
      month_adj_hurdle_fn(matched_data$all_month5, 5, data = matched_data),
      month_adj_hurdle_fn(matched_data$all_month6, 6, data = matched_data),
      month_adj_hurdle_fn(matched_data$all_month7, 7, data = matched_data),
      month_adj_hurdle_fn(matched_data$all_month8, 8, data = matched_data),
      month_adj_hurdle_fn(matched_data$all_month9, 9, data = matched_data),
      month_adj_hurdle_fn(matched_data$all_month10, 10, data = matched_data),
      month_adj_hurdle_fn(matched_data$all_month11, 11, data = matched_data),
      month_adj_hurdle_fn(matched_data$all_month12, 12, data = matched_data),
)
...
month_full_hurdle_fn <- function(month, n, data) {
      # Fit a hurdle model to the data.
      model <- hurdle(
            month ~ exposure + age_cat + sex + region + ethnicity_6 + 
                  imd_q5 + cov_covid_vax_n_cat + bmi_cat + 
                  number_comorbidities_cat | exposure + age_cat + sex,
            data = data,
            zero.dist = "binomial",
            dist = "poisson"
      )
...
all_full_adj_results <- bind_rows(
      month_full_hurdle_fn(matched_data$all_month1, 1, data = matched_data),
      month_full_hurdle_fn(matched_data$all_month2, 2, data = matched_data),
      month_full_hurdle_fn(matched_data$all_month3, 3, data = matched_data),
      month_full_hurdle_fn(matched_data$all_month4, 4, data = matched_data),
      month_full_hurdle_fn(matched_data$all_month5, 5, data = matched_data),
      month_full_hurdle_fn(matched_data$all_month6, 6, data = matched_data),
      month_full_hurdle_fn(matched_data$all_month7, 7, data = matched_data),
      month_full_hurdle_fn(matched_data$all_month8, 8, data = matched_data),
      month_full_hurdle_fn(matched_data$all_month9, 9, data = matched_data),
      month_full_hurdle_fn(matched_data$all_month10, 10, data = matched_data),
      month_full_hurdle_fn(matched_data$all_month11, 11, data = matched_data),
      month_full_hurdle_fn(matched_data$all_month12, 12, data = matched_data),
)
