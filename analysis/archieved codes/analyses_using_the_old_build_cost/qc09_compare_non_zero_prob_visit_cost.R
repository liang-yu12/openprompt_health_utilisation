...
# save outputs:
ggsave(file = "output/qc09_non_zero_counts_comparison.svg", 
...
# save outputs:
ggsave(file = "output/qc09_gp_non_zero_counts_comparison.svg", 
       device = "svg", width = 12, height = 4)
...
# save outputs:
ggsave(file = "output/qc09_hos_non_zero_counts_comparison.svg", 
       device = "svg", width = 12, height = 4)
...
# save outputs:
ggsave(file = "output/qc09_ae_non_zero_counts_comparison.svg", 
       device = "svg", width = 12, height = 4)
...
# save outputs:
ggsave(file = "output/qc09_opa_non_zero_counts_comparison.svg", 
       device = "svg", width = 12, height = 4)
