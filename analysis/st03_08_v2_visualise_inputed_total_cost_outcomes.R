...
# Binomial models: ---------------
total_binomial <- read_csv("output/st03_03_v2_inputed_total_cost_binary.csv") %>% 
...
# tpm models: -------------
# Read in results: 
combine_tpm <- read_csv("output/st03_03_v2_inputed_total_cost_gammaglm.csv") %>% 
...
total_predicted_cost <- read_csv("output/st03_03_v2_inputed_total_cost_predicted_costs.csv") 
...
ggsave(all_cost_plots, file = "output/st03_08_v2_inputed_total_cost.svg",
       device = "svg",
