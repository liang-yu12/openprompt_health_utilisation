source("analysis/new_dm04_02_01_combine_gp_costs_pivot.R")
...
# combine and save
bind_rows(gp_cost_total, gp_cost_by_month) %>% write_csv(here("output", "new_qc10_gp_cost_distribution.csv"))
...
# combine and save: 
bind_rows(hos_cost_total, hos_cost_month) %>% write_csv(here("output", "new_qc10_hos_cost_distribution.csv"))
...
bind_rows(ane_cost_total, ane_cost_month) %>% write_csv(here("output", "new_qc10_ane_cost_distribution.csv"))

# OPA costs: ----
source("analysis/new_dm04_02_04_opa_costs_pivot.R")
...
bind_rows(opa_cost_total, opa_cost_month) %>% write_csv(here("output", "new_qc10_opa_cost_distribution.csv"))
