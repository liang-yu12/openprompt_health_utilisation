...
sink(here("output", "st02_02_02_gponly_reg_summary.txt"))
...
st02_02_gp_binomial %>% write_csv(here("output", "st02_02_02_gponly_binomial.csv"))

st02_02_gp_hurdle <- bind_rows(crude_hurdle_outputs, adj_hurdle_outputs)
st02_02_gp_hurdle %>% write_csv(here("output", "st02_02_02_gponly_hurdle.csv"))
...
summarised_results %>% write_csv(here("output", "st02_02_02_gponly_predicted_counts.csv"))
...
bind_rows(
      ...
      write_csv("output/st02_02_02_gponly_binomial_model_counts.csv")
...
bind_rows(
      ...
      (hurdle_model_count_fn(adj_gp_complete_12m) %>% mutate(time = "12m")) %>% 
            mutate(model = "Adjusted")) %>% 
      write_csv("output/st02_02_02_gponly_hurdle_model_counts.csv")
