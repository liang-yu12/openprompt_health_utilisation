...
matched_data_opa_ts$month %>% table
# # 3 months
...
matched_data_opa_3m$exposure <- relevel(matched_data_opa_3m$exposure, ref = "Comparator")
matched_data_opa_6m$exposure <- relevel(matched_data_opa_6m$exposure, ref = "Comparator")
...
# # write outputs:
all_reg_results %>% write_csv(here("output", "st_02_0109_y_opa_no_cluster_model.csv"))
