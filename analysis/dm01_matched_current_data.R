...
matched_data$all_month_m1 <- rowSums(matched_data[, grepl("m1$", names(matched_data)), with = FALSE], na.rm = T)
matched_data$all_month_m2 <- rowSums(matched_data[, grepl("m2$", names(matched_data)), with = FALSE], na.rm = T)
matched_data$all_month_m3 <- rowSums(matched_data[, grepl("m3$", names(matched_data)), with = FALSE], na.rm = T)
matched_data$all_month_m4 <- rowSums(matched_data[, grepl("m4$", names(matched_data)), with = FALSE], na.rm = T)
matched_data$all_month_m5 <- rowSums(matched_data[, grepl("m5$", names(matched_data)), with = FALSE], na.rm = T)
matched_data$all_month_m6 <- rowSums(matched_data[, grepl("m6$", names(matched_data)), with = FALSE], na.rm = T)
matched_data$all_month_m7 <- rowSums(matched_data[, grepl("m7$", names(matched_data)), with = FALSE], na.rm = T)
matched_data$all_month_m8 <- rowSums(matched_data[, grepl("m8$", names(matched_data)), with = FALSE], na.rm = T)
matched_data$all_month_m9 <- rowSums(matched_data[, grepl("m9$", names(matched_data)), with = FALSE], na.rm = T)
matched_data$all_month_m10 <- rowSums(matched_data[, grepl("m10$", names(matched_data)), with = FALSE], na.rm = T)
matched_data$all_month_m11 <- rowSums(matched_data[, grepl("m11$", names(matched_data)), with = FALSE], na.rm = T)
matched_data$all_month_m12 <- rowSums(matched_data[, grepl("m12$", names(matched_data)), with = FALSE], na.rm = T)
