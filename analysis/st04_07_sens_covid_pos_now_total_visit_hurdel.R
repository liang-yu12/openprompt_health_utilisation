...
# Only run the model among people had been tested positive before index date
matched_data_12m <- matched_data_12m %>% filter(covid_positive == "TRUE")
...
sink(here("output", "st04_07_sens_covid_pos_total_reg_summary.txt"))
...
st03_01_total_binomial %>% write_csv(here("output", "st04_07_sens_covid_pos_total_binomial.csv"))

st03_01_total_hurdle <- bind_rows(crude_hurdle_outputs, adj_hurdle_outputs)
st03_01_total_hurdle %>% write_csv(here("output", "st04_07_sens_covid_pos_total_hurdle.csv"))
...
bind_rows(crude_summarised_results, adj_summarised_results) %>% 
  write_csv(here("output", "st04_07_sens_covid_pos_total_predicted_counts.csv"))
...
bind_rows(
      ...
      write_csv("output/st04_07_sens_covid_pos_total_binomial_model_counts.csv")
...
bind_rows(
      ...
      write_csv("output/st04_07_sens_covid_pos_hurdle_model_counts.csv")
